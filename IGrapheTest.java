...
class IGrapheTest {
	private IGraphe[] graphes = { new GrapheLArcs(), new GrapheMAdj(), new GrapheLAdj(), new GrapheHHAdj() };

	// graphe de l'exercice 3.1 du poly de maths
	// avec en plus un noeud isole : J
	private String g31 = "A-C(2), A-D(1), " + "B-G(3), " + "C-H(2), " + "D-B(3), D-C(5), D-E(3), "
	...
	void testImportation(IGraphe g) throws NumberFormatException, FileNotFoundException {
		...
		assertEquals(g.toString(),
				"1-3(5), " + "10-3(3), 2-1(5), 2-3(5), 2-5(4), " + "3-4(4), 3-5(4), 4-10(1), 4-2(1), 4-7(3), "
						+ "5-9(4), 6-2(3), 6-3(4), 7-3(2)," + " 8-2(4), 8-6(1), 9-2(4)");
